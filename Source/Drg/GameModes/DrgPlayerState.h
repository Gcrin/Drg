...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnWaveNumberChanged, int32, bool);
...
public:
	...
	bool GetbIsLastWave() const { return bIsLastWave; }
	void SetCurrentWaveNumber(int32 NewWaveNumber);
	void SetbIsLastWave(bool LastWaveCheck);
